...
export interface IJobOrderTripExpensePaymentDetail {
  ...
  pay_to_bank_account_owner_name?: string;
  note?: string;
  pay_from_bank_name?: string;
  pay_from_bank_account_number?: string;
}

export interface IJobOrderTripExpensePaymentForm {
  form: FormInstance;
  detailData?: IJobOrderTripExpensePaymentDetail;
